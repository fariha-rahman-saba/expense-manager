...
public class Constants {
    ...
    public static void setCategories() {
        ...
        categories.add(new Category("Investment", R.drawable.ic_investment, R.color.category6));
        categories.add(new Category("Utilities", R.drawable.home, R.color.category3));
        categories.add(new Category("Food", R.drawable.dish, R.color.category4));
